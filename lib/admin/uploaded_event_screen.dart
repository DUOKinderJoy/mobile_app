...
import '../parents/parentsModel/dashboard.dart';

class UploadedEventScreen extends StatelessWidget {
          ...
          if (dataSnapShot.data!.length > 0) {
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector(
                  onTap: () {
                    Get.to(UploadedItemDetailsScreen(itemInfo: eachClothItemRecord));
                  },
                  child: Container(
                    margin: EdgeInsets.fromLTRB(
                      16,

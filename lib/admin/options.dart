            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  child: const Text('View Orders of Meals'),
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => AdminGetAllOrdersScreen()),
                    );
                    //teacher sign up page
                  },
                ),
                ...
                ElevatedButton(
                  ...
                  child: const Text('View payments of parents'),
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => AdminGetAllPaymentScreen()),
                    );
                    //teacher sign up page
                  },
                ),
